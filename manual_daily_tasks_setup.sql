-- MANUAL SETUP: Run this SQL in your Supabase SQL Editor
-- This sets up the simplified daily task auto-creation system
...
-- Helper function to check IST time and date
CREATE OR REPLACE FUNCTION get_ist_info()
RETURNS TABLE(
...
-- Grant execute permissions
GRANT EXECUTE ON FUNCTION get_ist_info() TO authenticated;
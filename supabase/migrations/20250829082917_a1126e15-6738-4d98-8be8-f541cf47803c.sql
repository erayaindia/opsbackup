-- First, delete any profiles that don't have a user_id
...
-- Convert all user_id columns to UUID type for consistency
ALTER TABLE public.channel_members ALTER COLUMN user_id TYPE uuid USING user_id::uuid;
ALTER TABLE public.channels ALTER COLUMN created_by TYPE uuid USING created_by::uuid;
ALTER TABLE public.messages ALTER COLUMN user_id TYPE uuid USING user_id::uuid;
ALTER TABLE public.reactions ALTER COLUMN user_id TYPE uuid USING user_id::uuid;

-- Make user_id the primary key in profiles

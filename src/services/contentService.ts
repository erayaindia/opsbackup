...
export class ContentService {
  ...
  // ============= Planning Data =============
  static async savePlanningData(contentId: string, planningData: { concept?: string; body?: string; cta?: string; }) {
    try {
      console.log('💾 Saving planning data for content:', contentId, planningData);
  ...
  static async getPlanningData(contentId: string) {
    try {
      console.log('📖 Fetching planning data for content:', contentId);
      ...
      return data || { concept: '', body: '', cta: '' };
    } catch (error) {
      console.error('Failed to fetch planning data:', error);
      // Return empty data instead of throwing to prevent breaking the UI
      return { concept: '', body: '', cta: '' };
    }
  }

  static async deletePlanningData(contentId: string) {
    try {
      console.log('🗑️ Deleting planning data for content:', contentId);
      ...
      console.log('✅ Planning data deleted successfully');
      return true;
    } catch (error) {

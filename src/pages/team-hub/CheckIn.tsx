...
import { CheckCircle, LogOut, ArrowLeft } from 'lucide-react';
...
const CheckIn = () => {
  const [currentStep, setCurrentStep] = useState<'login' | 'location' | 'selfie' | 'complete'>('login');
  ...
  const steps: AttendanceStep[] = [
    ...
    { id: 'location', title: 'Location Verification', completed: ['selfie', 'complete'].includes(currentStep), current: currentStep === 'location' },
    { id: 'selfie', title: 'Photo Verification', completed: currentStep === 'complete', current: currentStep === 'selfie' },
    { id: 'complete', title: 'Check-in Complete', completed: isCheckedIn, current: currentStep === 'complete' },
  ];
  ...
  // Success state
  if (currentStep === 'complete' && isCheckedIn) {
    return (
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Welcome! Your attendance has been recorded successfully.
            </p>
          </div>
          <Button
        ...
        <Card className="max-w-md mx-auto">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div className="flex gap-2">
              <Button onClick={handleNewCheckIn} className="flex-1" variant="outline">
